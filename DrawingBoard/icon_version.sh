...
icons_path="${PROJECT_DIR}/DrawingBoard/Assets.xcassets/AppIcon.appiconset"
icons_dest_path="${PROJECT_DIR}/DrawingBoard/Assets.xcassets/AppIcon-Internal.appiconset"
